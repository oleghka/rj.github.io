    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid15", tween: [ "style", "${_window}", "opacity", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeInBack" },
                { id: "eid20", tween: [ "transform", "${_window}", "scaleY", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeInBack" },
                { id: "eid18", tween: [ "transform", "${_window}", "scaleX", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeInBack" }            ]
        }
    }
}
};
